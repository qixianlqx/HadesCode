...
var projectType = [
    ...
    { num: 4, name: '成品厚度公差', attr: '±10% <br> ±3mil （ 板 厚 ≤ 0.8mm <br> Board Thickness ≤ 0.8mm', typeid: 1 },
    ...
    { num: 14, name: '内层设计线宽<br>间距(最小)', attr: 'H/HOZ 3.0mil/3.0mil(0.075mm /0.075mm) <br> 1/1OZ 4mil/4mil(0.1016mm/ 0.1016mm) <br> 2/2OZ 5mil/5mil(0.127mm/0.127mm) <br> 3/3OZ6mil/6mil(0.152mm/0.152mm)', typeid: 1 },
    { num: 15, name: '外层设计线宽<br>间距(最小)', attr: 'T/TOZ 3.0mil/3.0mil (0.075mm/ 0.075mm）<br> H/HOZ 3.5mil/3.5mil(0.089mm/0.089mm) <br> 1/1OZ 4.5mil/4.5mil (0.114mm/0.114mm ) <br> 2/2OZ 6mil/6mil (0.152mm/0.152mm ) <br> 3/3OZ 7mil/7mil (0.152mm/0.152mm)', typeid: 1 },
    ...
    { num: 4, name: '成品厚度公差', attr: '±10% <br> ±0.03mm （板厚≤ 0.2mm）<br> ±0.05mm （0.2mm＜板厚≤ 0.5mm）', typeid: 2 },
    { num: 5, name: '分层结构/盲埋孔', attr: 'YES', typeid: 2 },
    { num: 6, name: '最小孔径孔径', attr: '机械钻孔：0.1mm~6.5mm <br> 镭射钻孔：0.1-0.125mm', typeid: 2 },
    ...
    { num: 14, name: '内层设计线宽<br> 间距(最小)', attr: 'T/TOZ 1.6mil/1.6mil(0.04mm /0.04mm) <br> H/HOZ 2.0mil/2.0mil(0.05mm /0.05mm) <br> 1/1OZ 3mil/3mil(0.075mm/ 0.075mm)', typeid: 2 },
    { num: 15, name: '外层设计线宽<br>间距(最小)', attr: 'T/TOZ 2.0mil/2.0mil (0.05mm/ 0.05mm）<br> H/HOZ 3.0mil/3.0mil(0.075mm/0.075mm) <br> 1/1OZ 4.0mil/4.0mil (0.1mm/0.1mm )', typeid: 2 },
    ...
    { num: 20, name: '外形公差 <br>(孔到边)(最小)', attr: '±4mil ( ±0.1mm)', typeid: 2 },
    { num: 21, name: '最小测试能力', attr: 'PAD Size min （0.1mm）<br> PAD Pitch min (0.4mm)', typeid: 2 },
